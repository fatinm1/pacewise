/**
 * Static sample data for demos and NEXT_PUBLIC_USE_MOCK_DATA mode.
 * Shapes match dbt mart / API response types in `types/strava`.
 */
...
export const MOCK_WEEKLY: WeeklyPerformance[] = [
  {
    week_start: "2025-02-17",
    total_distance_km: 42,
    total_moving_time_hours: 4.2,
  ...
  },
  {
    ...
    total_moving_time_hours: 3.5,
    avg_pace_min_per_km: 4.9,
    avg_heartrate: 150,
    activity_count: 4,
  },
];

export const MOCK_TRAINING_LOAD: TrainingLoadPoint[] = [
...
export const MOCK_HR_ZONES: HeartRateZoneBucket[] = [
...
export const MOCK_PACE_TREND: PaceTrendPoint[] = [
...
export const MOCK_ATHLETE: AthleteSummary = {
  name: "Demo Athlete",
  avatar_url: null,
  member_since: "2024-01-15",
  total_activities: 127,
  last_sync_at: "2025-03-04T12:00:00.000Z",
};

export function getMockForApiPath(path: string): unknown {
